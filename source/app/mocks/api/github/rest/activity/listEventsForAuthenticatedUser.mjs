...
export default function (
  ...
  target,
  that,
  [{ username: login, page, per_page }]
) {
  console.debug(
    `metrics/compute/mocks > mocking rest api result > rest.activity.listEventsForAuthenticatedUser`
  );
  return {
    status: 200,
                ...
                commits: [
                  {
                    ...
                    url:
                      "https://api.github.com/repos/lowlighter/metrics/commits/MOCKED_SHA",
                  },
                ],
              },
              created_at: faker.date.recent(7),
