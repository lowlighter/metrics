    ...
    //GraphQL API mocking
      {
        ...
        graphql = new Proxy(unmocked, {
          apply(target, that, args) {
            ...
            //Repositories query
              if (/^query BaseRepositories /.test(query)) {
            ...
            //Single repository query
              if (/^query BaseRepository /.test(query)) {
            ...
            //Calendar query
              if (/^query IsocalendarCalendar /.test(query)) {
            ...
            //Gists query
              if (/^query GistsDefault /.test(query)) {
            ...
            //Projects query
              if (/^query ProjectsUser /.test(query)) {
            ...
            //Repository project query
              if (/^query ProjectsRepository /.test(query)) {
            ...
            //Starred repositories query
              if (/^query StarsDefault /.test(query)) {
            ...
            //Stargazers query
              if (/^query StargazersDefault /.test(query)) {
            ...
            //People query
              if (/^query PeopleDefault /.test(query)) {
