    ...
    try {
      ...
      //Result
        return {
          ...
          readme:{
            demo:raw.match(/(?<demo><table>[\s\S]*?<[/]table>)/)?.groups?.demo?.replace(/<[/]?(?:table|tr)>/g, "")?.trim() ?? (name === "community" ? `<td>See <a href="/source/templates/community/README.md">documentation</a>to use community templates 🌍</td>` : "<td></td>"),
